...
class Match {
  ...
  int get freeSlots => (maxParticipants - acceptedCount).clamp(0, maxParticipants);
  bool get isJoinable =>
      status == MatchStatus.open && freeSlots > 0;
  ...
  factory Match.fromJson(Map<String, dynamic> json) => Match(
        ...
        recruitmentMode:
            RecruitmentMode.fromWire(json['recruitment_mode'] as String),
